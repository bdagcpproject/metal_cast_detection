...
table_id = "confidencescore_metrics"
...
schema = [
    ...
    bigquery.SchemaField("confidence_score_min", "FLOAT"),
    bigquery.SchemaField("confidence_score_med", "FLOAT"),
    bigquery.SchemaField("confidence_score_mean", "FLOAT"),
    bigquery.SchemaField("confidence_score_max", "FLOAT"),
